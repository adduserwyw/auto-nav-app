...
export const ModeSelector = ({
  ...
  const { handleContinuousStepCommand } = useBluetoothControl(connectedDevice);

  useEffect(() => {
    if (mode === 'disconnected') {
      // handleContinuousStepCommand("stop");
    }
    if (connectedDevice) {
      // handleContinuousStepCommand("manual");
    }
  }, [mode]);
      ...
      <View style={styles.radioGroup}>
        <Pressable
          ...
          onPress={() => {
            ...
            sendBluetoothCommand(connectedDevice, BASIC_COMMANDS.manual, false);
          }}>
        ...
        <Pressable
          style={styles.radioOption}
          onPress={() => {
            onModeChange('waypoint');
            if (!connectedDevice) return;
            sendBluetoothCommand(connectedDevice, BASIC_COMMANDS.sendWaypoints, false);
          }}>
          <View style={styles.radioOuterCircle}>
